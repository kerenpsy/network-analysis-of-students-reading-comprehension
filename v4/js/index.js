...
let instruction = {
  ...
  stimulus: `
    ...
    你想了解和提高自己的阅读水平吗？
      ...
      <br>
      第二种是<span class="redT">评分题</span>，需要根据文意，对词语之间的<span class="redT" style="font-style: italic;">关系</span>进行评分；
      <br>
...
let part1E = {
  ...
  请你仔细阅读以下文章，<br>
  分别完成<span class="redT">选择题</span>、<span class="redT">评分题</span>与<span class="redT">简答题</span>的题目。
  </p>
`,
  choices: ['开始']
};
...
function createMultiLikert2(article, type) {
  return {
    ...
    preamble: function () {
      let curQuest = ''
      if (type === 'E') {
        curQuest = '三、评分题：以下为相邻性评分，即根据词语之间的位置关系远近进行评分。<br></div><div style="width:80%;margin:0 auto;font-size:24px;line-height:45px;;text-align:left;font-style: italic;">1分表示两组关键词在文中的距离很远；9分表示两组关键词在文中相邻；5分表示两组关键词在文中距离中等。'
      } else {
        curQuest = '三、评分题：以下为关联性性评分，即根据词语之间的逻辑关系远近进行评分。<br></div><div style="width:80%;margin:0 auto;font-size:24px;line-height:45px;;text-align:left;font-style: italic;">1分表示关键词之间没有关系；9分表示关键词之间关系密切；5分表示关键词之间有关系，但关系相对较小。'
      }
      let text =
        `
    <div style="width:80%;margin:0 auto;font-size:24px;line-height:45px">
